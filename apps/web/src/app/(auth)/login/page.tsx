    ...
    <div className="min-h-dvh flex">
      ...
      <div className="hidden lg:flex lg:w-[48%] relative bg-navy-900 flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="font-display text-[42px] font-bold text-white/90 leading-[1.15] tracking-tight">
            Labor, Força
            <br />e Virtude
          </h2>
          <p className="text-white/25 text-sm mt-3 font-medium tracking-[0.15em] uppercase">
            N.o 003
          </p>
        </div>
        ...
        <div className="w-full max-w-sm animate-fade-up">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-card">
            ...
            {error && (
              <Alert
                variant="destructive"
                className="mb-5 animate-scale-in rounded-xl"
              >
